...
public class ForumController : ControllerWithAuthentication
{
    ...
    [OpenApiAuthentication]
    [OpenApiParameter("forumId", In = ParameterLocation.Path, Type = typeof(string), Required = true, Description = "The forum post Id")]
    ...
    [OpenApiAuthentication]
    [OpenApiParameter("forumId", In = ParameterLocation.Path, Type = typeof(string), Required = true, Description = "The forum post Id")]
    [OpenApiParameter("replyId", In = ParameterLocation.Path, Type = typeof(string), Required = true, Description = "The forum post reply Id")]
